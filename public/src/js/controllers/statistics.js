...
function($scope, $routeParams, Statistics, StatisticsByDaysTransactions, StatisticsByDaysOutputs, StatisticsByDaysFees, StatisticsByDaysDifficulty, StatisticsByDaysStakes, Statistics24Hours, gettextCatalog, $filter, Consajwms, StatisticChart, MarketsInfo) {
	...
	var self = this,
		...
		self.chartText = {
			...
			transactions: gettextCatalog.getString('The number of daily confirmed AJWM transactions.'),
		...
		self.marketCurrency = Consajwms.CURRENCY.USD;
		self.marketPrice = 0;
