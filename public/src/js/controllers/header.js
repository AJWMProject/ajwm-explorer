...
function($scope, $rootScope, $route, gettextCatalog, amMoment, getSocket, Block, $templateCache, Consajwms, $location) {

	var self = this;
	var socket = getSocket($scope);
	self.defaultLanguage = Consajwms.DEFAULT_LANGUAGE;
